...
class GroceryListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery_list" do
    assert_difference('GroceryList.count') do
      post grocery_lists_url, params: { grocery_list: { default: @grocery_list.default, name: @grocery_list.name, total: @grocery_list.total, user_id: @grocery_list.user_id } }, as: :json
    end
  ...
  test "should update grocery_list" do
    patch grocery_list_url(@grocery_list), params: { grocery_list: { default: @grocery_list.default, name: @grocery_list.name, total: @grocery_list.total, user_id: @grocery_list.user_id } }, as: :json
    assert_response 200
  end
